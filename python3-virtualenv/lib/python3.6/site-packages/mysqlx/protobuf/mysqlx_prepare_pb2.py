...
_PREPARE_ONEOFMESSAGE_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="FIND", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INSERT", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="UPDATE", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DELETE", index=3, number=4, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STMT", index=4, number=5, options=None, type=None
        ),
    ],
...
_PREPARE_ONEOFMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="find",
            full_name="Mysqlx.Prepare.Prepare.OneOfMessage.find",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="insert",
            full_name="Mysqlx.Prepare.Prepare.OneOfMessage.insert",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="update",
            full_name="Mysqlx.Prepare.Prepare.OneOfMessage.update",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="delete",
            full_name="Mysqlx.Prepare.Prepare.OneOfMessage.delete",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="stmt_execute",
            full_name="Mysqlx.Prepare.Prepare.OneOfMessage.stmt_execute",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
_PREPARE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stmt_id",
            full_name="Mysqlx.Prepare.Prepare.stmt_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="stmt",
            full_name="Mysqlx.Prepare.Prepare.stmt",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_EXECUTE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stmt_id",
            full_name="Mysqlx.Prepare.Execute.stmt_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="args",
            full_name="Mysqlx.Prepare.Execute.args",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Prepare.Execute.compact_metadata",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_DEALLOCATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stmt_id",
            full_name="Mysqlx.Prepare.Deallocate.stmt_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
...
_PREPARE_ONEOFMESSAGE.fields_by_name[
    "stmt_execute"
].message_type = mysqlx__sql__pb2._STMTEXECUTE
...
Prepare = _reflection.GeneratedProtocolMessageType(
    "Prepare",
    (_message.Message,),
    dict(
        OneOfMessage=_reflection.GeneratedProtocolMessageType(
            "OneOfMessage",
            (_message.Message,),
            dict(
...
Deallocate = _reflection.GeneratedProtocolMessageType(
    "Deallocate",
    (_message.Message,),
    dict(
