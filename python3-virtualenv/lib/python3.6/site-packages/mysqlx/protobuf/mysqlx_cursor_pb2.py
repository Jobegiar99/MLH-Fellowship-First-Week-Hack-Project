...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        mysqlx__prepare__pb2.DESCRIPTOR,
    ],
)
...
_OPEN_ONEOFMESSAGE_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="PREPARE_EXECUTE", index=0, number=0, options=None, type=None
        ),
    ],
...
_OPEN_ONEOFMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Cursor.Open.OneOfMessage.prepare_execute",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_OPEN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cursor_id",
            full_name="Mysqlx.Cursor.Open.cursor_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="stmt",
            full_name="Mysqlx.Cursor.Open.stmt",
            index=1,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fetch_rows",
            full_name="Mysqlx.Cursor.Open.fetch_rows",
            index=2,
            number=5,
            type=4,
            cpp_type=4,
...
_FETCH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cursor_id",
            full_name="Mysqlx.Cursor.Fetch.cursor_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="fetch_rows",
            full_name="Mysqlx.Cursor.Fetch.fetch_rows",
            index=1,
            number=5,
            type=4,
            cpp_type=4,
...
_CLOSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cursor_id",
            full_name="Mysqlx.Cursor.Close.cursor_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
...
_OPEN_ONEOFMESSAGE.fields_by_name[
    "prepare_execute"
].message_type = mysqlx__prepare__pb2._EXECUTE
