...
_EXPR_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="IDENT", index=0, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LITERAL", index=1, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="VARIABLE", index=2, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FUNC_CALL", index=3, number=4, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="OPERATOR", index=4, number=5, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLACEHOLDER", index=5, number=6, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="OBJECT", index=6, number=7, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ARRAY", index=7, number=8, options=None, type=None
        ),
    ],
...
_DOCUMENTPATHITEM_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="MEMBER", index=0, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MEMBER_ASTERISK", index=1, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ARRAY_INDEX", index=2, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ARRAY_INDEX_ASTERISK", index=3, number=4, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DOUBLE_ASTERISK", index=4, number=5, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
