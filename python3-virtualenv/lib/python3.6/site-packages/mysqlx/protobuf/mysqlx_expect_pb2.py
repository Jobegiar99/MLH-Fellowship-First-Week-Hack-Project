...
_OPEN_CONDITION_KEY = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="EXPECT_NO_ERROR", index=0, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EXPECT_FIELD_EXIST", index=1, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EXPECT_DOCID_GENERATED", index=2, number=3, options=None, type=None
        ),
    ],
