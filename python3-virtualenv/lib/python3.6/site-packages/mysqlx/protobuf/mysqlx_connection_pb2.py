...
_COMPRESSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Connection.Compression.uncompressed_size",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Connection.Compression.server_messages",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Connection.Compression.client_messages",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="Mysqlx.Connection.Compression.payload",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_COMPRESSION.fields_by_name[
    "server_messages"
].enum_type = mysqlx__pb2._SERVERMESSAGES_TYPE
_COMPRESSION.fields_by_name[
    "client_messages"
].enum_type = mysqlx__pb2._CLIENTMESSAGES_TYPE
...
Compression = _reflection.GeneratedProtocolMessageType(
    "Compression",
    (_message.Message,),
    dict(
